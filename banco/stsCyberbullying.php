...
/*echo 'esta qui';*/
$status_cyberbullying = $_POST['status_cyberbullying'];
$id = $_POST['id'];
...
if ($results['status_cyberbullying'] !== 'aprovado') {
    $sql = "update usuarios set status_cyberbullying = '$status_cyberbullying' where id = $id";
